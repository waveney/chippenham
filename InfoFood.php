...
<?php
  $Food = Gen_Get_Cond('FoodAndDrink', "Year=$PLANYEAR ORDER By Importance DESC, Name");
  foreach ($Food as $f) {
    echo "<tr><td>" . $f['Name'] . "<td><button onclick=ShowDirect(" . (2000000 + $T['id']) . ")>Directions</button>\n";
  }
?>
