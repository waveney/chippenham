CREATE TABLE `SideYear` (
  ...
  `SatArrive` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `SatDepart` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `SunArrive` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `SunDepart` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `MonArrive` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `MonDepart` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `Invited` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  ...
  `OtherPayment` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  ...
  `Rider` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  ...
  `FriAvail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `SatAvail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `SunAvail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `MonAvail` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
