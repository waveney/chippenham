<?php
  ...
  echo "<script src=/js/lightbox.js?V=$VERSION></script>";
  echo "<link href=/css/lightbox.css?V=$VERSION rel=stylesheet>";
  echo "<script src=/js/responsiveslides.js?V=$VERSION></script>";
  echo "<link href=/css/responsiveslides.css?V=$VERSION rel=stylesheet>";
