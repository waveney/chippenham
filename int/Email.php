...
function Replace_Help($Area='',$Right=0) {
  ...
  ['*PERF*','Name of performer','Dance,Music,Family,Ceilidh,Youth'],
  ['*SIDE*','Name of side','Dance,Music,Family,Ceilidh,Youth'],
  ['*TICKBOX:b:TEXT*','Direct link to click a box, b=num(1-4)|Rec(eived)|..., TEXT to be displayed (NO SPACES - any _ will appear as spaces)',
    'Dance,Music,Trade'],
