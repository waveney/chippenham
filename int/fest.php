...
$Sections = ['', 'Docs', 'Dance', 'Trade', 'Users', 'Venues', 'Music', 'Sponsors', 'Finance', 'Craft', 'OtherPerf', 'TLine', 'Bugs', 'Photos',
   'Comedy', 'Family', 'News', 'Volunteers', 'Art', 'Tickets', 'Events', 'Ceilidh', 'Biz', 'Youth', 'Collect']; 
   // DO NOT CHANGE ORDER IF CHANGED, JUST ADD
...
function dominimalhead($title,$extras=[]) {
  global $head_done,$CONF,$FESTSYS,$VERSION;
  $pfx="";
  if (isset($CONF['TitlePrefix'])) $pfx = $CONF['TitlePrefix'];
  echo "<html><head>";
  echo "<title>$pfx " . Feature('ShortName') . " | $title</title>\n";
