...
//echo "<p>Vols: "; var_dump($Volunt);
  ...
  echo "<table border><tr><th>Campsite, who";
...
//    foreach($CampTypes as $CT) echo "<td>" . $CT['Name'];
    ...
    for($Syid = $LowId; $Syid <= $HighId; $Syid++) {
      ...
      echo "<tr class=FullD hidden><td><a href=AddPerf?id=" . $Use[$Csi][$Syid]['Sid'] . ">" . $SNames[$Use[$Csi][$Syid]['Sid']] . "</a>";
...
//echo "V is $V<br>";
      ...
      echo "<tr class=FullD hidden><td>Volunteer - <a href=Volunteers?A=" . ($VolMgr? "Show":"View") . "&id=$V>" . $Volunt[$V]['SN'] . "</a>";
